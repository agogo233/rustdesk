...
//*************************************************************
//
//  DeleteMyDeskTestCertsW_SingleHive()
//
...
BOOL DeleteMyDeskTestCertsW_SingleHive(HKEY RootKey, LPWSTR Prefix = NULL) {
...
extern "C" void DeleteMyDeskTestCertsW() {
	...
	DeleteMyDeskTestCertsW_SingleHive(HKEY_LOCAL_MACHINE);
	...
	for (DWORD Index = 0; ; Index++) {
		...
		DeleteMyDeskTestCertsW_SingleHive(HKEY_USERS, SubKeyName);
	}
