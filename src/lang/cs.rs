...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k MyDesk síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), MyDesk v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak MyDesk do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci MyDesk udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci MyDesk udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby MyDesk mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [MyDesk vstup]."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep RustDesk background service", "Zachovat službu MyDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace MyDesk, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění MyDesk \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění MyDesk \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného MyDesku."),
        ...
        ("verify_mydesk_password_tip", "Ověření hesla MyDesk"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby MyDesk a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Aktualizujte prosím MyDesk Server Pro na verzi {} nebo novější!"),
        ...
        ("selinux_tip", "Na vašem zařízení je povolen SELinux, což může bránit správnému běhu MyDesku jako řízené strany."),
        ...
        ("powered_by_me", "Poháněno společností MyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povolit připojení pouze v případě, že je otevřené okno MyDesk"),
        ...
        ("floating_window_tip", "Pomáhá udržovat službu MyDesk na pozadí"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Upgradujte prosím klienta MyDesk na verzi {} nebo novější na vzdálené straně!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Ve výchozím nastavení MyDesk ověřuje certifikát serveru u protokolů používajících TLS.\nKdyž je tato možnost povolena, MyDesk v případě selhání ověření přejde k přeskočení kroku ověření a bude pokračovat."),
        ("Disable UDP", "Zakázat UDP"),
        ("disable-udp-tip", "Určuje, zda se má používat pouze TCP.\nKdyž je tato možnost povolena, MyDesk již nebude používat UDP 31116, místo toho se použije TCP 31116."),
        ("server-oss-not-support-tip", "POZNÁMKA: MyDesk server OSS tuto funkci neobsahuje."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk nemůže získat přístup k relaci plochy na vzdáleném zařízení, ověřte, že relace běží a že ji MyDesk může použít"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk nezískal z XDG Desktop Portal použitelnou obrazovku, knihovna PipeWire může být příliš stará"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk nemohl načíst komponentu GStreameru potřebnou k zachycení obrazovky ({})"),
