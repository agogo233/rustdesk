...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_mydesk_password_tip", "Пацвердзіць пароль RustDesk"),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Абнавіце RustDesk Server Pro да версіі {} або навейшай!"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Абнавіце кліент RustDesk да версіі {} або навейшай на баку абанента!"),
