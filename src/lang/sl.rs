...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem MyDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, MyDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate MyDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate MyDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno MyDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »MyDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Ohrani MyDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije MyDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "MyDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "MyDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_mydesk_password_tip", "Preveri geslo za MyDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite MyDesk, prekinite klic in program zaprite."),
        ("scam_text2", "MyDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Prosimo, nadgradite MyDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo MyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno MyDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri MyDesk storitvi v ozadju"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Prosimo, nadgradite MyDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ...
        ("allow-insecure-tls-fallback-tip", "Privzeto MyDesk preverja strežniško potrdilo za protokole, ki uporabljajo TLS.\nKo je ta možnost omogočena, bo MyDesk ob neuspelem preverjanju preskočil korak preverjanja in nadaljeval."),
        ("Disable UDP", "Onemogoči UDP"),
        ("disable-udp-tip", "Določa, ali naj se uporablja samo TCP.\nKo je ta možnost omogočena, MyDesk ne bo več uporabljal UDP 31116, namesto tega bo uporabljen TCP 31116."),
        ("server-oss-not-support-tip", "OPOMBA: Strežnik MyDesk OSS ne vključuje te funkcije."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk ne more dostopati do namizne seje na oddaljeni napravi, preverite, ali seja teče in ali jo MyDesk lahko uporablja"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk od XDG Desktop Portala ni dobil uporabnega zaslona, knjižnica PipeWire je morda prestara"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk ni mogel naložiti komponente GStreamer, potrebne za zajem zaslona ({})"),
    ].iter().cloned().collect();
}
