...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na MyDesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a MyDesk ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate MyDesk na sustav."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfiguracija"),
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, MyDesk-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, MyDesk-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti MyDesk-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [MyDesk Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep RustDesk background service", "Zadrži MyDesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje MyDesk aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti MyDesku dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti MyDesku \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog MyDeska."),
        ...
        ("verify_mydesk_password_tip", "Provjera lozinke za MyDesk"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete MyDesk, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Ažurirajte MyDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti MyDesk da pravilno radi kao upravljana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti vezu samo ako je prozor MyDeska otvoren"),
        ...
        ("floating_window_tip", "Pomaže u održavanju pozadinskog servisa MyDeska"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Molimo ažurirajte MyDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Prema zadanim postavkama, MyDesk provjerava certifikat poslužitelja za protokole koji koriste TLS.\nKada je ova opcija omogućena, MyDesk će u slučaju neuspjele provjere preskočiti korak provjere i nastaviti."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Određuje hoće li se koristiti samo TCP.\nKada je ova opcija omogućena, MyDesk više neće koristiti UDP 31116, već će umjesto toga koristiti TCP 31116."),
        ("server-oss-not-support-tip", "NAPOMENA: MyDesk poslužitelj OSS ne uključuje ovu značajku."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk ne može pristupiti sesiji radne površine na udaljenom uređaju, provjerite radi li sesija i može li je MyDesk koristiti"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk nije mogao dobiti upotrebljiv zaslon od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk nije mogao učitati GStreamer komponentu potrebnu za snimanje zaslona ({})"),
    ].iter().cloned().collect();
}
