...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään MyDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa MyDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi MyDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava MyDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava MyDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten MyDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota MyDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli MyDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "MyDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa MyDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "MyDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep RustDesk background service", "Pidä MyDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista MyDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_mydesk_password_tip", "Vahvista MyDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "MyDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Päivitä MyDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About RustDesk", "Tietoa MyDeskistä"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Päivitä etä-MyDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
        ...
        ("allow-insecure-tls-fallback-tip", "Oletuksena MyDesk vahvistaa palvelimen varmenteen TLS:ää käyttävissä protokollissa.\nKun tämä asetus on käytössä, MyDesk ohittaa vahvistusvaiheen ja jatkaa toimintaa, jos vahvistus epäonnistuu."),
        ("Disable UDP", "Poista UDP käytöstä"),
        ("disable-udp-tip", "Määrittää, käytetäänkö vain TCP:tä.\nKun tämä asetus on käytössä, MyDesk ei enää käytä UDP-porttia 31116, vaan sen sijaan käytetään TCP-porttia 31116."),
        ("server-oss-not-support-tip", "HUOMAUTUS: MyDesk-palvelimen OSS ei sisällä tätä ominaisuutta."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk ei tavoita etälaitteen työpöytäistuntoa, tarkista että istunto on käynnissä ja että MyDesk voi käyttää sitä"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk ei saanut XDG Desktop Portalilta käyttökelpoista näyttöä, PipeWire-kirjasto voi olla liian vanha"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk ei voinut ladata näytön kaappaukseen tarvittavaa GStreamer-osaa ({})"),
    ].iter().cloned().collect();
}
