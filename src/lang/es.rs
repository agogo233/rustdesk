...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red MyDesk en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que MyDesk no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar MyDesk a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a MyDesk de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a MyDesk de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que MyDesk use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [MyDesk Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Dejar MyDesk como Servicio en 2do plano"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a MyDesk permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a MyDesk permisos de \"Grabar Audio\"."),
        ...
        ("verify_mydesk_password_tip", "Verificar la contraseña de MyDesk"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses MyDesk e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "¡Por favor, actualiza MyDesk Server Pro a la versión {} o superior"),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que MyDesk no se ejecute correctamente como lado controlado."),
        ...
        ("powered_by_me", "Con tecnología de MyDesk"),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de MyDesk de fondo"),
        ...
        ("About RustDesk", "Acerca de MyDesk"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Por favor, actualiza el cliente MyDesk a la versión {} o superior en el lado remoto"),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk no puede acceder a la sesión de escritorio del dispositivo remoto; compruebe que hay una sesión en marcha y que MyDesk puede usarla"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk no ha podido obtener una pantalla utilizable del XDG Desktop Portal; la biblioteca PipeWire puede ser demasiado antigua"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk no ha podido cargar un componente de GStreamer necesario para capturar la pantalla ({})"),
