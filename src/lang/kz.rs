...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_mydesk_password_tip", "RustDesk құпия сөзін тексеру"),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "RustDesk Server Pro'ны {} немесе одан жаңа нұсқаға жаңартуды өтінеміз!"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Қашықтағы жақтағы RustDesk клиентін {} немесе одан жоғары нұсқаға жаңартуды өтінеміз!"),
