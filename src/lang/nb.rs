...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter tilkobling til MyDesk-nettverket..."),
        ...
        ("install_tip", "På grunn av UAC kan MyDesk ikke fungere korrekt i enkelte tillfeller på fjernskrivebordet. For å unngå UAC klikker du på knappen nedenfor for å installere MyDesk på systemet"),
        ("Click to upgrade", "Klikk for å oppgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For å kontrollere ditt skrivebord med fjernstyring må du gi MyDesk \"Access \" Rettigheter."),
        ("config_screen", "For å kunne få adgang til ditt skrivebord med fjernstyring, må du gi MyDesk \"skjerstøtte \" tillatelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhet kan kontrollere din Android-enhet via mus eller berøring, må du gi MyDesk mulighet til å bruke tjenesten \"tilgjengelighet \"."),
        ("android_input_permission_tip2", "Gå til den neste systeminnstillingssiden, søk og tast inn [installerte tjenester], aktiver [MyDesk Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du vil deaktivere denne funksjonen, gå til neste innstillingsside for MyDesk-applikasjonen, finn og åpne [Batteri], og fjern haken ved [Ubegrenset]."),
        ...
        ("config_input", "For å kunne styre fjernskrivebordet med tastatur må du gi MyDesk tillatelsen \"Inndataovervåking\"."),
        ("config_microphone", "For å kunne snakke eksternt må du gi MyDesk tillatelsen \"Ta opp lyd\"."),
        ...
        ("still_click_uac_tip", "Krever fortsatt at fjernbrukeren klikker OK på UAC-vinduet til den kjørende MyDesk."),
        ...
        ("verify_mydesk_password_tip", "Verifiser MyDesk-passord"),
        ...
        ("scam_text1", "Hvis du snakker i telefonen med noen du IKKE kjenner OG STOLER PÅ, som har bedt deg om å bruke MyDesk og starte tjenesten, ikke fortsett og legg på umiddelbart."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Vennligst oppgrader MyDesk Server Pro til versjon {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktivert på enheten din, noe som kan hindre MyDesk i å fungere som det skal på den kontrollerte siden."),
        ...
        ("powered_by_me", "Drevet av MyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Tillat kun tilkobling hvis MyDesk-vinduet er åpent"),
        ...
        ("floating_window_tip", "Det bidrar til å holde MyDesk-bakgrunnstjenesten i gang"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Vennligst oppgrader MyDesk-klienten til versjon {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifiserer MyDesk serversertifikatet for protokoller som bruker TLS.\nMed dette alternativet aktivert vil MyDesk falle tilbake til å hoppe over verifiseringstrinnet og fortsette ved verifiseringsfeil."),
        ("Disable UDP", "Deaktiver UDP"),
        ("disable-udp-tip", "Styrer om kun TCP skal brukes.\nNår dette alternativet er aktivert, vil MyDesk ikke lenger bruke UDP 31116, TCP 31116 brukes i stedet."),
        ("server-oss-not-support-tip", "MERK: MyDesk server OSS inkluderer ikke denne funksjonen."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk får ikke tilgang til skrivebordsøkten på den eksterne enheten, kontroller at en økt kjører og at MyDesk kan bruke den"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk fikk ingen brukbar skjerm fra XDG Desktop Portal, PipeWire-biblioteket kan være for gammelt"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk kunne ikke laste en GStreamer-komponent som kreves for skjermopptak ({})"),
