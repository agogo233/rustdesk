...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete MyDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), MyDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare MyDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a MyDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a MyDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a MyDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [MyDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep RustDesk background service", "Mantieni il servizio di MyDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione MyDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show RustDesk", "Visualizza MyDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a MyDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a MyDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di MyDesk."),
        ...
        ("verify_mydesk_password_tip", "Conferma password MyDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare MyDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Aggiorna MyDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di MyDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da MyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra MyDesk è aperta"),
        ...
        ("floating_window_tip", "Aiuta a mantenere il servizio MyDesk in background."),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Aggiorna il client MyDesk remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, MyDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, MyDesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, MyDesk non userà più UDP 31116, verrà invece usato TCP 31116."),
        ("server-oss-not-support-tip", "Nota: il sistema operativo del server MyDesk non include questa funzionalità."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk non riesce a raggiungere la sessione desktop nel dispositivo remoto, controlla che sia in esecuzione una sessione desktop e che MyDesk possa usarla"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk non è riuscito a ottenere una schermata usabile dal portale desktop XDG, la libreria PipeWire potrebbe essere troppo vecchia"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk non è riuscito a caricare un componente GStreamer necessario per l'acquisizione dello schermo ({})"),
    ].iter().cloned().collect();
}
