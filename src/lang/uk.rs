...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі MyDesk..."),
        ...
        ("install_tip", "Через UAC, в деяких випадках MyDesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення MyDesk в системі"),
        ("Click to upgrade", "Натисніть, щоб перевірити наявність оновлень"),
        ("Configure", "Налаштувати"),
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати MyDesk дозволи \"Спеціальні можливості\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці, вам необхідно надати MyDesk дозволи на \"Запис екрана\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або дотику, вам необхідно дозволити MyDesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Будь ласка, перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [MyDesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep RustDesk background service", "Зберегти фонову службу MyDesk"),
        ...
        ("config_input", "Для віддаленого керування віддаленою стільницею з клавіатури, вам необхідно надати MyDesk дозволи на \"Відстеження введення\""),
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати MyDesk дозвіл на \"Запис аудіо\""),
        ...
        ("verify_mydesk_password_tip", "Перевірте пароль MyDesk"),
        ...
        ("scam_text1", "Якщо ви розмовляєте по телефону з кимось, кого НЕ ЗНАЄТЕ чи кому НЕ ДОВІРЯЄТЕ, і ця особа хоче, щоб ви використали MyDesk та запустили службу, не робіть цього та негайно завершіть дзвінок."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Будь ласка, оновіть MyDesk Server Pro до версії {} чи новіше!"),
        ...
        ("selinux_tip", "SELinux увімкнено на вашому пристрої, що може ускладнити для іншої сторони віддалене керування за допомогою MyDesk."),
        ...
        ("powered_by_me", "На основі MyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Дозволяти підключення лише коли відкрите вікно MyDesk"),
        ...
        ("floating_window_tip", "Допомагає зберегти фонову службу MyDesk"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Будь ласка, оновіть MyDesk клієнт на віддаленому пристрої до версії {} чи новіше!"),
        ...
        ("allow-insecure-tls-fallback-tip", "За замовчуванням MyDesk перевіряє сертифікат сервера для протоколів, які використовують TLS.\nКоли цей параметр увімкнено, у разі помилки перевірки MyDesk пропустить крок перевірки та продовжить."),
        ("Disable UDP", "Вимкнути UDP"),
        ("disable-udp-tip", "Визначає, чи використовувати лише TCP.\nКоли цей параметр увімкнено, MyDesk більше не використовуватиме UDP 31116, замість нього буде використано TCP 31116."),
        ("server-oss-not-support-tip", "ПРИМІТКА: сервер MyDesk OSS не містить цієї функції."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk не може отримати доступ до сеансу стільниці на віддаленому пристрої, перевірте, чи запущено сеанс і чи може MyDesk його використовувати"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk не зміг отримати придатний екран від XDG Desktop Portal, бібліотека PipeWire може бути застарою"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk не вдалося завантажити компонент GStreamer, потрібний для захоплення екрана ({})"),
