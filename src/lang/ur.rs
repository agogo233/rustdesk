...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Language", "زبان"),
        ("Keep RustDesk background service", "MyDesk پس منظر کی خدمت کو برقرار رکھیں"),
        ...
        ("verify_mydesk_password_tip", "MyDesk پاس ورڈ کی تصدیق کریں"),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "براہِ کرم MyDesk Server Pro کو ورژن {} یا اس سے نئے پر اپ گریڈ کریں!"),
        ...
        ("About RustDesk", "MyDesk کے بارے میں"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "براہِ کرم دور دراز فریق پر MyDesk کلائنٹ کو ورژن {} یا اس سے نئے پر اپ گریڈ کریں!"),
