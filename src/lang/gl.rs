...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("disable-udp-tip", "Controla se usar só TCP.\nCando esta opción estea activada, RustDesk xa non usará o porto UDP 31116; no seu lugar usarase o porto TCP 31116."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk non pode acceder á sesión de escritorio do dispositivo remoto, comprobe que hai unha sesión en marcha e que MyDesk pode usala"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk non puido obter unha pantalla utilizable do XDG Desktop Portal, a biblioteca PipeWire pode ser demasiado antiga"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk non puido cargar un compoñente de GStreamer necesario para capturar a pantalla ({})"),
    ].iter().cloned().collect();
}
