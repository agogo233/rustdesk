...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "MyDesk sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, MyDesk ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian MyDesk sistema mailan instalatzeko."),
        ("Click to upgrade", "Egin klik bertsio-berritzeko"),
        ("Configure", "Konfiguratu"),
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, MyDesk-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, MyDesk-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, MyDesk \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [MyDesk Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep RustDesk background service", "Mantendu MyDesk atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez MyDesk aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, MyDesk-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, MyDeski-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den MyDesk UAC leihoan"),
        ...
        ("verify_mydesk_password_tip", "Berretsi MyDesk pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta MyDesk erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu MyDesk Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek MyDesk kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa MyDesk leihoa irekita badago"),
        ...
        ("floating_window_tip", "MyDesk atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Mesedez, eguneratu MyDesk bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Modu lehenetsian, MyDesk-ek zerbitzariaren ziurtagiria egiaztatzen du TLS erabiltzen duten protokoloetarako.\nAukera hau gaituta dagoela, MyDesk-ek egiaztapen-urratsa saltatzera joko du eta aurrera egingo du egiaztapenak huts eginez gero."),
        ("Disable UDP", "Desgaitu UDP"),
        ("disable-udp-tip", "TCP soilik erabiliko den kontrolatzen du.\nAukera hau gaituta dagoenean, MyDesk-ek ez du gehiago UDP 31116 erabiliko; horren ordez, TCP 31116 erabiliko da."),
        ("server-oss-not-support-tip", "OHARRA: MyDesk zerbitzariaren OSS bertsioak ez du ezaugarri hau barne hartzen."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk-ek ezin du urruneko gailuko mahaigaineko saioa atzitu, egiaztatu saio bat martxan dagoela eta MyDesk-ek erabil dezakeela"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk-ek ezin izan du pantaila erabilgarririk lortu XDG Desktop Portal-etik, PipeWire liburutegia zaharregia izan daiteke"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk-ek ezin izan du pantaila kapturatzeko beharrezkoa den GStreamer osagai bat kargatu ({})"),
    ].iter().cloned().collect();
}
