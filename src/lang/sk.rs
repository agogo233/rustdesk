...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Pripájam sa na MyDesk server..."),
        ...
        ("install_tip", "V niektorých prípadoch MyDesk nefunguje správne z dôvodu riadenia užívateľských oprávnení (UAC). Vyhnete sa tomu kliknutím na nižšie zobrazene tlačítko a nainštalovaním RuskDesk do systému."),
        ("Click to upgrade", "Kliknutím nainštalujete aktualizáciu"),
        ("Configure", "Nastaviť"),
        ("config_acc", "Aby bolo možné na diaľku ovládať vašu plochu, je potrebné aplikácii MyDesk udeliť práva \"Dostupnosť\"."),
        ("config_screen", "Aby bolo možné na diaľku sledovať vašu obrazovku, je potrebné aplikácii MyDesk udeliť práva \"Zachytávanie obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby bolo možné na diaľku ovládať vašu plochu pomocou myši alebo dotykov, je potrebné aplikácii MyDesk udeliť práva \"Dostupnosť\"."),
        ("android_input_permission_tip2", "Prejdite na stránku nastavení systému, nájdite a vstúpte do [Stiahnuté služby], zapnite [MyDesk Input] službu."),
        ...
        ("Turned off", "Vypnutý"),
        ("Language", "Jazyk"),
        ("Keep RustDesk background service", "Ponechať službu MyDesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovať optimalizácie batérie"),
        ("android_open_battery_optimizations_tip", "Ak chcete túto funkciu vypnúť, prejdite na ďalšiu stránku nastavení MyDesku, vyhľadajte a zadajte položku [Batéria], zrušte začiarknutie položky [Neobmedzené]."),
        ...
        ("config_input", "Ak chcete ovládať vzdialenú plochu pomocou klávesnice, musíte udeliť oprávnenie MyDesk \"Sledovanie vstupu\"."),
        ("config_microphone", "Ak chcete hovoriť na diaľku, musíte MyDesku udeliť povolenie \"Nahrávať zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále sa vyžaduje, aby vzdialený používateľ klikol na tlačidlo OK v okne UAC spusteného programu MyDesk."),
        ...
        ("verify_mydesk_password_tip", "Overenie hesla MyDesk"),
        ...
        ("scam_text1", "Ak telefonujete s niekým, koho nepoznáte a komu nedôverujete a kto vás požiadal o použitie a spustenie aplikácie MyDesk, nepokračujte v hovore a okamžite zaveste."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Aktualizujte MyDesk Server Pro na verziu {} alebo novšiu!"),
        ...
        ("selinux_tip", "Na vašom zariadení je povolený SELinux, čo môže brániť správnemu spusteniu MyDesku ako spravovanej strany."),
        ...
        ("powered_by_me", "Poháňané aplikáciou MyDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Povoliť pripojenie iba vtedy, ak je otvorené okno aplikácie MyDesk"),
        ...
        ("floating_window_tip", "Pomáha udržiavať službu MyDesk na pozadí"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Aktualizujte klienta MyDesk na verziu {} alebo novšiu na vzdialenej strane!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Štandardne MyDesk overuje certifikát servera pre protokoly používajúce TLS.\nS touto možnosťou MyDesk v prípade zlyhania overenia preskočí krok overovania a bude pokračovať."),
        ("Disable UDP", "Vypnúť UDP"),
        ("disable-udp-tip", "Určuje, či sa má používať iba TCP.\nKeď je táto možnosť povolená, MyDesk už nebude používať UDP 31116, namiesto neho sa použije TCP 31116."),
        ("server-oss-not-support-tip", "POZNÁMKA: MyDesk server OSS túto funkciu neobsahuje."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk nemá prístup k relácii plochy na vzdialenom zariadení, overte, či relácia beží a či ju MyDesk môže použiť"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk nezískal z XDG Desktop Portal použiteľnú obrazovku, knižnica PipeWire môže byť príliš stará"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk nedokázal načítať komponent GStreamera potrebný na zachytenie obrazovky ({})"),
