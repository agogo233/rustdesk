...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "MyDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa MyDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et MyDesk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb MyDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb MyDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma MyDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [MyDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RustDesk background service", "Säilita MyDeski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele MyDeski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma MyDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma MyDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud MyDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_mydesk_password_tip", "Kinnita MyDeski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul MyDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Palun täienda MyDesk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib MyDeskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb MyDeskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui MyDeski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada MyDeski taustateenust."),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Täiendage MyDeski klient kaugküljel versioonile {} või uuemale!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Vaikimisi kontrollib MyDesk TLS-i kasutavate protokollide puhul serveri sertifikaati.\nKui see valik on lubatud, jätab MyDesk kontrollimissammu vahele ja jätkab kontrolli ebaõnnestumise korral."),
        ("Disable UDP", "Keela UDP"),
        ("disable-udp-tip", "Määrab, kas kasutada ainult TCP-d.\nKui see valik on lubatud, ei kasuta MyDesk enam UDP 31116, vaid kasutatakse selle asemel TCP 31116."),
        ("server-oss-not-support-tip", "MÄRKUS: MyDeski serveri OSS ei sisalda seda funktsiooni."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk ei pääse kaugseadmes töölauaseansini, kontrollige, kas seanss töötab ja kas MyDesk saab seda kasutada"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk ei saanud XDG Desktop Portalilt kasutatavat ekraani, PipeWire'i teek võib olla liiga vana"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk ei suutnud laadida ekraani jäädvustamiseks vajalikku GStreameri komponenti ({})"),
    ].iter().cloned().collect();
}
