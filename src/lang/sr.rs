...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Zbog UAC MyDesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate MyDesk na sistem."),
        ("Click to upgrade", "Klik za nadogradnju"),
        ("Configure", "Konfigurisanje"),
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, MyDesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, MyDesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite MyDesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [MyDesk Input] servis."),
        ...
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje MyDesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ...
        ("config_input", "Da biste upravljali udaljenom radnom površinom tastaturom, potrebno je da dodelite MyDesk-u dozvolu \"Praćenje unosa\"."),
        ("config_microphone", "Da biste govorili na daljinu, potrebno je da dodelite MyDesk-u dozvolu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "I dalje zahteva da udaljeni korisnik klikne OK na UAC prozoru pokrenutog MyDesk-a."),
        ...
        ("verify_mydesk_password_tip", "Potvrdi MyDesk lozinku"),
        ...
        ("scam_text1", "Ako razgovarate telefonom sa nekim koga NE poznajete I kome NE VERUJETE, a ko vas je zamolio da koristite MyDesk i pokrenete servis, nemojte nastaviti i odmah prekinite vezu."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Molimo nadogradite MyDesk Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "SELinux je omogućen na vašem uređaju, što može sprečiti MyDesk da radi pravilno kao kontrolisana strana."),
        ...
        ("allow-only-conn-window-open-tip", "Dozvoli konekciju samo ako je MyDesk prozor otvoren"),
        ...
        ("floating_window_tip", "Pomaže da se MyDesk pozadinski servis održi"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Molimo nadogradite MyDesk klijent na verziju {} ili noviju na udaljenoj strani!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Podrazumevano, MyDesk proverava sertifikat servera za protokole koji koriste TLS.\nSa omogućenom ovom opcijom, MyDesk će preskočiti korak provere i nastaviti u slučaju neuspele provere."),
        ("Disable UDP", "Onemogući UDP"),
        ("disable-udp-tip", "Kontroliše da li se koristi samo TCP.\nKada je ova opcija omogućena, MyDesk više neće koristiti UDP 31116, umesto toga će se koristiti TCP 31116."),
        ("server-oss-not-support-tip", "NAPOMENA: MyDesk server OSS ne uključuje ovu funkciju."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk ne može da pristupi sesiji radne površine na udaljenom uređaju, proverite da li sesija radi i da li MyDesk može da je koristi"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk nije mogao da dobije upotrebljiv ekran od XDG Desktop Portala, PipeWire biblioteka je možda prestara"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk nije mogao da učita GStreamer komponentu potrebnu za snimanje ekrana ({})"),
    ].iter().cloned().collect();
}
