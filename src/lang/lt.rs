...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_mydesk_password_tip", "Įveskite kliento RustDesk slaptažodį"),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Prašome atnaujinti RustDesk Server Pro į versiją {} ar naujesnę!"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Prašome atnaujinti nuotolinės pusės RustDesk klientą į {} ar naujesnę versiją!"),
