...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_mydesk_password_tip", "تحقق من كلمة مرور RustDesk"),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "ترقية خادم RustDesk Pro إلى {}"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "ترقية عميل RustDesk البعيد إلى {}"),
