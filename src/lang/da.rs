...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til MyDesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan MyDesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere MyDesk på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give MyDesk \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give MyDesk \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give MyDesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [MyDesk Input] tjenesten."),
        ...
        ("Turned off", "Slukket"),
        ("Language", "Sprog"),
        ("Keep RustDesk background service", "Behold MyDesk baggrundstjeneste"),
        ("Ignore Battery Optimizations", "Ignorér betteri optimeringer"),
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn MyDesk appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af MyDesk er nødvendigt."),
        ("Always use software rendering", "Brug altid software rendering"),
        ("config_input", "For at styre fjernskrivebordet med tastaturet, skal du give MyDesk rettigheder til at optage tastetryk"),
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give MyDesk rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af MyDesk."),
        ...
        ("verify_mydesk_password_tip", "Bekræft MyDesk adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge MyDesk til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Opgradér venligst MyDesk Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre MyDesk i at køre normalt."),
        ...
        ("powered_by_me", "Drives af MyDesk"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af MyDesk med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis MyDesk vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at MyDesk baggrundstjenesten kører"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Opgrader venligst MyDesk-klienten til version {} eller nyere på fjernsiden!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verificerer MyDesk servercertifikatet for protokoller, der bruger TLS.\nNår denne indstilling er aktiveret, vil MyDesk springe verificeringstrinnet over og fortsætte, hvis verificeringen mislykkes."),
        ("Disable UDP", "Deaktivér UDP"),
        ("disable-udp-tip", "Bestemmer, om der kun skal bruges TCP.\nNår denne indstilling er aktiveret, vil MyDesk ikke længere bruge UDP 31116; i stedet bruges TCP 31116."),
        ("server-oss-not-support-tip", "BEMÆRK: MyDesk server OSS indeholder ikke denne funktion."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk kan ikke nå skrivebordssessionen på fjernenheden, kontrollér at en session kører, og at MyDesk kan bruge den"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk kunne ikke få en brugbar skærm fra XDG Desktop Portal, PipeWire-biblioteket er måske for gammelt"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk kunne ikke indlæse en GStreamer-komponent, der kræves til skærmoptagelse ({})"),
    ].iter().cloned().collect();
}
