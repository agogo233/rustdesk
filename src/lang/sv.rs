...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till MyDesk..."),
        ...
        ("install_tip", "På grund av UAC, kan inte MyDesk fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera MyDesk på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge MyDesk \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge MyDesk \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [MyDesk Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep RustDesk background service", "Behåll MyDesk i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa MyDesk programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("config_input", "För att kunna styra fjärrskrivbordet med tangentbordet måste du ge MyDesk behörigheten \"Övervaka inmatning\"."),
        ("config_microphone", "För att kunna tala på distans måste du ge MyDesk behörigheten \"Spela in ljud\"."),
        ...
        ("still_click_uac_tip", "Kräver fortfarande att fjärranvändaren klickar på OK i UAC-fönstret för MyDesk."),
        ...
        ("verify_mydesk_password_tip", "Verifiera MyDesk-lösenord"),
        ...
        ("scam_text1", "Om du talar i telefon med någon du INTE känner OCH litar på, som har bett dig använda MyDesk och starta tjänsten, fortsätt inte och lägg på omedelbart."),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Uppgradera MyDesk Server Pro till version {} eller senare!"),
        ...
        ("selinux_tip", "SELinux är aktiverat på din enhet, vilket kan hindra MyDesk från att fungera korrekt som kontrollerad sida."),
        ("Change view", "Byt vy"),
        ...
        ("allow-only-conn-window-open-tip", "Tillåt endast anslutning om MyDesk-fönstret är öppet"),
        ...
        ("floating_window_tip", "Det hjälper till att hålla MyDesk-bakgrundstjänsten igång"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Uppgradera MyDesk-klienten till version {} eller senare på fjärrsidan!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Som standard verifierar MyDesk serverns certifikat för protokoll som använder TLS.\nMed detta alternativ aktiverat hoppar MyDesk över verifieringssteget och fortsätter om verifieringen misslyckas."),
        ("Disable UDP", "Inaktivera UDP"),
        ("disable-udp-tip", "Styr om endast TCP ska användas.\nNär detta alternativ är aktiverat använder MyDesk inte längre UDP 31116, utan TCP 31116 används i stället."),
        ("server-oss-not-support-tip", "OBS: MyDesk server OSS inkluderar inte denna funktion."),
        ...
        ("RustDesk cannot reach the desktop session on the remote device, check that a desktop session is running and that RustDesk can use it", "MyDesk kan inte nå skrivbordssessionen på fjärrenheten, kontrollera att en session körs och att MyDesk kan använda den"),
        ...
        ("RustDesk could not obtain a usable screen from the XDG Desktop Portal, the PipeWire library may be too old", "MyDesk fick ingen användbar skärm från XDG Desktop Portal, PipeWire-biblioteket kan vara för gammalt"),
        ("RustDesk could not load a GStreamer component needed for screen capture ({})", "MyDesk kunde inte läsa in en GStreamer-komponent som krävs för skärminspelning ({})"),
    ].iter().cloned().collect();
}
