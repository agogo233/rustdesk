...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_mydesk_password_tip", "Verify RustDesk password"),
        ...
        ("upgrade_mydesk_server_pro_to_{}_tip", "Please upgrade RustDesk Server Pro to version {} or newer!"),
        ...
        ("upgrade_remote_mydesk_client_to_{}_tip", "Please upgrade the RustDesk client to version {} or newer on the remote side!"),
