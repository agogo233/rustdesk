...
* `flutter/` current UI
* `libs/hbb_common/` submodule of agogo233/hbb_common (Mod branch), source repo at `/home/git/working/hbb_common/`; shared with the server: rendezvous proto, sockets, `Config` core
