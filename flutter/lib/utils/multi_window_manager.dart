...
class MyDeskMultiWindowManager {
  MyDeskMultiWindowManager._();

  static final instance = MyDeskMultiWindowManager._();
  ...
  /// `myDeskWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final myDeskWinManager = MyDeskMultiWindowManager.instance;
